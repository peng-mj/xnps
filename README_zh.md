...
nps是一款轻量级、高性能、功能强大的**内网穿透**。目前支持**tcp、udp流量转发**，可支持任何**tcp、udp**上层协议（访问内网网站、本地支付接口调试、ssh访问、远程桌面，内网dns解析等等……），此外还**支持内网http代理、内网socks5代理**，并带有功能强大的web管理端。
...
### 安装
> [releases](https://github.com/peng-mj/xnps/releases)
