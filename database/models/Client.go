...
type Client struct {
	...
	RateLimit          uint32     `gorm:"column:rate_limit;type:integer;default:0;not null" json:"rateLimit"`            //网速限制
	ConnRateLimit      uint32     `gorm:"column:rate_limit;type:integer;default:0;not null" json:"ConnRateLimit"`        //连接速率限制
	...
	MaxConn            uint32     `gorm:"column:max_conn;type:integer;not null;default:100" json:"maxConn"`              //最大连接数 ，这个应该放在隧道上边
	NowConn            uint32     `gorm:"column:now_conn;type:integer;not null;default:0" json:"nowConn"`                //当前连接数，应该放在隧道上边
	AllowUseConfigFile bool       `gorm:"column:allow_file_config;not null;default:true" json:"allowUseConfigFile"`      //不允许用户使用配置文件登录
	MaxTunnelNum       uint32     `gorm:"column:max_tunnel_num;type:integer;not null;default:20" json:"maxTunnelNum"`    //最大限制20个，单个终端
