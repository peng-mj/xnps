...
func newConnGroup(dst, src io.ReadWriteCloser, wg *sync.WaitGroup, n *int64, flow *models2.Flow, task *models2.Tunnel, remote string) connGroup {
	return connGroup{
		src:    src,
		dst:    dst,
		wg:     wg,
...
func CopyBuffer(dst io.Writer, src io.Reader, flow *models2.Flow, task *models2.Tunnel, remote string) (err error) {
...
func NewConns(c1 io.ReadWriteCloser, c2 net.Conn, flow *models2.Flow, wg *sync.WaitGroup, task *models2.Tunnel) Conns {
	return Conns{
		conn1: c1,
		conn2: c2,
		flow:  flow,
